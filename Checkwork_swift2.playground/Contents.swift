...
func rotate(str1: String, str2: String) -> Bool {
    ...
    let strReversed = String(str2.characters.reverse())
...
print(rotate(str1: "pot", str2: "top")
print(rotate("life", str2: "tech"))
...
print(rating(2002, g: 2017))
print(rating(4500, g: 0))
...
print(oneOut(1, b: 5, c: 1))
print(oneOut(2, b: 2, c: 4))
